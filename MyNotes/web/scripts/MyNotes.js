var MyNotesFunc = (function () {
 	...
 	MyNotes.prototype.getNotes = function(path, settings,  successHandler, errorHandler) {
 		send_ajax_get('/list?path='+ path + '/', settings, successHandler, errorHandler);
 	};
 	...
 	*/
 	...
 	MyNotes.prototype.Note.prototype.add = function(settings, successHandler, errorHandler) {
       ...
       payload = {
		...
		send_ajax_post('/add', 'application/json', JSON.stringify(payload), settings, successHandler, errorHandler);
	...
	MyNotes.prototype.Note.prototype.remove = function(settings, successHandler, errorHandler) {
	   ...
	   send_ajax_post('/remove', 'application/json',  JSON.stringify(payload), settings, successHandler, errorHandler);	
	};
	...
	MyNotes.prototype.Note.prototype.view = function(settings, successHandler, errorHandler) {
	  ...
	  send_ajax_post('/details', 'application/json',  JSON.stringify(payload), settings, successHandler, errorHandler);	
	};
